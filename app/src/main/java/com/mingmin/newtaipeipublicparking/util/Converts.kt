...
object Converts {
     ...
     */
    fun twd97ToLatLng(tw97x: Double, tw97y: Double): LatLng {
        val dx = 250000.0
        val dy = 0.0
    ...
    /**
     * Decode polyline points of Google Map Directions API
     * Refernce: https://github.com/irenenaya/Kotlin-Practice/blob/master/MapsRouteActivity.kt
     */
    fun polylinePointsToLatLngs(encoded: String): List<LatLng> {
